...
<body>
    ...
    <div class="d-flex justify-content-start">
        <div class="card ml-5" style="width: 720px; border-radius: 0;">
            <div class="m-3">
                <g:form controller="credencial" action="update">
                    <g:hiddenField name="id" value="${credencialCommand.id}" />
                    <g:render template="form" />
                    <div class="center-content">
                        <div class="container-box d-flex justify-content-end ">
                            <g:link controller="credencial" class="btn btn-volver" action="list">Volver</g:link>
                            <a onclick="borrarSwal()" id="${credencialCommand.id}" class="btn btn-primary"
                                href="javascript:;"
        ...
        function borrarSwal() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "${createLink(action:'delete',)}/" + '${credencialCommand.id}';
                }
            })
        }
    </script>
