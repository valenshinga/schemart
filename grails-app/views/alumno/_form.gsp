...
<div class="form-group row">
	...
	<div class="col-sm-10">
		<select id="cbTipoCurso" class="form-control" name="tipoCursoId" style="border-color: #084c61; color: #084c61;"></select>
	</div>
</div> 
<div class="form-group row">
...
<script>
	...
	$(document).ready(function () {
		...
		llenarCombo({
			comboId : "cbTipoCurso",
			ajaxLink : "${createLink(controller: 'alumno', action: 'ajaxGetTiposCursos')}",
			idDefault : '${command?.tipoCursoId}',
			atributo: "nombre"
		});
